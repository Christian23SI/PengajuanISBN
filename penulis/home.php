<div class="page-waraper">
    <div class="row">
        <div class="col-12">
            <div class="mt-2">
                <div class="welcomeadmin" style="height: 450px; background-image: url('asset/image/pcr1.png'); background-size: cover; background-position: center; text-align: center;">
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); ">
                    <h1 class="text-white" style="font-weight: bold;" >Selamat Datang Pengajuan ISBN PCR</h1>
                    </div>
...
<section class="page-section">
    <div class="container">
        <div class="row">
            <div class="text-center mx-4 mt-4 text-dark">
                ...
                <div class="row">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '            <a href="" class="btn btn-outline-primary">Detail</a>';
                            echo '        </div>';
                            echo '    </div>';
                            echo '</div>';
                        }
