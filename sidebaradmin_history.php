...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- home -->
            <li class="nav-item">
                <a class="nav-link " href="sidebaradmin_home.php" 
                   >
            ...
            <li class="nav-item active">
                <a class="nav-link" href="sidebaradmin_daftarbuku.php">
      ...
      <li class="nav-item active">
                <a class="nav-link" href="sidebaradmin_statuspengajuan.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <main>
                <?php 
                include 'admin/historypengajuan.php'; 
                ?>
            </main>
